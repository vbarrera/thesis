...
if (numbered=='TRUE'){
  png(paste(resultsDIR,"figure27_H1FilteredBNNumbered.png",sep=""),height=15,width=15,units="cm",res=300)
} else {
  png(paste(resultsDIR,"figure27_H1FilteredBN.png",sep=""),height=15,width=15,units="cm",res=300)
}
...
if(numbered=='TRUE'){
  png(paste(resultsDIR,"figure27_IMR90FilteredBNNumbered.png",sep=""),height=15,width=15,units="cm",res=300)
}else{
  png(paste(resultsDIR,"figure27_IMR90FilteredBN.png",sep=""),height=15,width=15,units="cm",res=300)
}
def.par <- par(no.readonly = TRUE)
par(lwd=3)
par(cex.axis=1.2)
...
if(numbered=='TRUE'){
  png(paste(resultsDIR,"figure27_H1AllBNNumbered.png",sep=""),height=15,width=15,units="cm",res=300)
}else{
png(paste(resultsDIR,"figure27_H1AllBN.png",sep=""),height=15,width=15,units="cm",res=300)
}
def.par <- par(no.readonly = TRUE)
par(lwd=3)
par(cex.axis=1.2)
...
if (numbered=='TRUE'){
  png(paste(resultsDIR,"figure27_AllIMR90BNNumbered.png",sep=""),height=15,width=15,units="cm",res=300)
}else{
png(paste(resultsDIR,"figure27_AllIMR90BN.png",sep=""),height=15,width=15,units="cm",res=300)
}
def.par <- par(no.readonly = TRUE)
par(lwd=3)
par(cex.axis=1.2)
