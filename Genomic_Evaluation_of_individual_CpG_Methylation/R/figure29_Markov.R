...
WHERE MPA.name=MEA.name AND R.RE_name='HpaII' AND E.type='CpGislandMarkov' 
AND MPA.RE_name='HpaII' AND MEA.type='CpGislandMarkov' AND C.type='CpGislandMarkov'")
...
if (numbered=='TRUE'){
  png(paste(resultsDIR,"figure29_MarkovH1FilteredBNNumbered.png",sep=""),height=15,width=15,units="cm",res=300)
} else {
  png(paste(resultsDIR,"figure29_MarkovH1FilteredBN.png",sep=""),height=15,width=15,units="cm",res=300)
}
...
if(numbered=='TRUE'){
  png(paste(resultsDIR,"figure29_MarkovIMR90FilteredBNNumbered.png",sep=""),height=15,width=15,units="cm",res=300)
}else{
  png(paste(resultsDIR,"figure29_MarkovIMR90FilteredBN.png",sep=""),height=15,width=15,units="cm",res=300)
}
def.par <- par(no.readonly = TRUE)
par(lwd=3)
par(cex.axis=1.2)
...
if(numbered=='TRUE'){
  png(paste(resultsDIR,"figure29_MarkovH1AllBNNumbered.png",sep=""),height=15,width=15,units="cm",res=300)
}else{
  png(paste(resultsDIR,"figure29_MarkovH1AllBN.png",sep=""),height=15,width=15,units="cm",res=300)
}
def.par <- par(no.readonly = TRUE)
par(lwd=3)
par(cex.axis=1.2)
...
if (numbered=='TRUE'){
  png(paste(resultsDIR,"figure29_MarkovAllIMR90BNNumbered.png",sep=""),height=15,width=15,units="cm",res=300)
}else{
  png(paste(resultsDIR,"figure29_MarkovAllIMR90BN.png",sep=""),height=15,width=15,units="cm",res=300)
}
def.par <- par(no.readonly = TRUE)
par(lwd=3)
par(cex.axis=1.2)
