...
for (A in listStates){
  ...
  save(pt,file=paste("chromatinStates/majorGroup/",folder,"/statesFiles/",A,".Rdata",sep=""))
  png(paste("chromatinStates/majorGroup/",folder,"/statesFiles/pngs/",A,".png",sep=""))
  plot(pt)
  dev.off()
  ...
  write.table(resultsDF,file=paste("chromatinStates/majorGroup/",folder,"/statesFiles/resultsDF",sep=""),sep=";",row.names=FALSE)
}
